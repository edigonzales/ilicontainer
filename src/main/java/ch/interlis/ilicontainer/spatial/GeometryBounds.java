    ...
    if (tag.equals("SEGMENTS")) {
      ...
      for (int i = 0; i < o.getattrvaluecount("segment"); i++) {
        ...
        if (segment.getobjecttag().equals("ARC")) {
          ...
          ch.interlis.ilicontainer.geometry.GeometryEnvelope.Envelope exact =
              new ch.interlis.ilicontainer.geometry.GeometryEnvelope.Envelope();
          ch.interlis.ilicontainer.geometry.GeometryEnvelope.arc(
