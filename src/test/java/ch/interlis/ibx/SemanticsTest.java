...
public class SemanticsTest {
  ...
  public void blackboxesAndOidlessAssociationsRoundtrip() throws Exception {
    ...
    Path file = tmp.getRoot().toPath().resolve("special.ibx");
    ...
    for (Path source : Arrays.asList(file, populated)) {
      ...
      Process p =
          new ProcessBuilder(
                  ...
                  "-Dhttps.proxyPort=9",
                  "-cp",
                  System.getProperty("ibx.test.classpath"),
                  "ch.interlis.ibx.cli.Main",
                  "export",
                  source.toString(),
                  out.toString())
  ...
  public void growingTransferScansInFixedHeap() throws Exception {
    ...
    Path file = tmp.getRoot().toPath().resolve("many.ibx");
