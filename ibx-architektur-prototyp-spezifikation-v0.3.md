...
# IbxContainer – Architektur und Prototyp-Spezifikation v0.3
...
Ein vollständiger INTERLIS-2.4-FULL-Transfer soll verlustfrei in einen IbxContainer überführt und wieder als semantisch gleichwertiger XTF-Transfer ausgegeben werden können.
...
IbxContainer open(URI uri); // selektiv: kein automatischer Full Download
...
1. Ein vollständiger INTERLIS-2.4-FULL-Transfer kann einschliesslich Metadaten, leerer Baskets und erforderlicher Reihenfolgen semantisch verlustfrei in IbxContainer und zurück überführt werden; andere Versionen und Transferarten werden ausdrücklich abgelehnt.
2. IbxContainer ist mit begrenztem Speicher als IOX-Eventfolge vollständig streambar, ohne zuvor Objekt- oder Spatial-Indizes lesen zu müssen.
