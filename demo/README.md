...
Erwarteter Einstieg: `g0` / „Haus am Park 1“ → `auftrag0` → rückwärts
...
Der Generator schreibt deterministisches XTF. Der IBX-Writer vergibt pro Erstellung
eine neue Dataset-UUID. Die Binärdatei muss daher nicht byteidentisch sein.
